                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <table width="100%"><tr><td><a href="analisa_soal_siswa.php"><button class="btn btn-default">
						...
						$nilaiawal = round($o['hasil'],2);
								...
								?>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td align="center"><a href=lks_siswa.php?soal=<?php echo $s['XKodeSoal']; ?>&siswa=<?php echo $s['XNomerUjian']; ?>&token=<?php echo $s['XTokenUjian']; ?>>
                                        <button type="button" class="btn btn-info btn-small"><i class="fa fa-file-text-o"></i></button></a></td>		

										<td align="center"><a href=jawabansiswa-.php?soal=<?php echo $s['XKodeSoal']; ?>&siswa=<?php echo $s['XNomerUjian']; ?>&token=<?php echo $s['XTokenUjian']; ?>>
